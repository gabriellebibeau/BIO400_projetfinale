...
Pour les figures 2, les autres variables sont fixées aux conditions énumérées dans la première figure de l'étude original (@polis_complex_1991), soit: $a = 1$, $\alpha = 0.5$, $b = 1$, $\beta = 1$, $K = 1$, $m = 0.5$, $m' = 0.5$ et $r = 1$. Dans l'étude de Polis en 1991, les variables $a'$ et $b'$ prennait le rôle
...
![Figure 3.1: États d'équilibres dans un écosystème avec les paramètres énumérées à la figures 1B avec un super-prédateur de type 1.](Fig2Condi2A.png)


![Figure 3.2: États d'équilibres dans un écosystème avec les paramètres énumérées à la figures 1B avec un super-prédateur de type 2.](Fig2Condi2B.png)

![Figure 3.3: États d'équilibres dans un écosystème avec les paramètres énumérées à la figures 1B avec un super-prédateur de type 3.](Fig2Condi2C.png)

![Figure 3.4: États d'équilibres dans un écosystème avec les paramètres énumérées à la figures 1B avec un super-prédateur de type 4.](Fig2Condi2D.png)


## Interprétation biologique 
###1. Figure 2.1 à 2.4

Les figures sont sensiblement les mêmes. Pour les 4 types de super-prédateur, le prédateur ne peut survivre: il est automatiquement extirpé. Lorsque le super-prédateur est efficasse à consommer la ressource et y possède une haute réponse fonctionnelle. Le système ressemble en terme de taille des zones exclusion
