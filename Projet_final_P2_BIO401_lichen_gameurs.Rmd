...
Dans le passé, plusieurs modèle ont été développés pour illustrer ces relations. Il y a le modèle consommateur-ressource, une généralisation de plusieurs modèles dont le modèle proie-prédateur de Lotka-Voltera. @holt_theoretical_1997 ont bonifiés ce dernier de PIG (une resource consommée par une proie et un prédateur). Ils ont trouvé que cet ajoût menait à plusieurs équilibres de populations instables. Nos objectifs sont de déterminer les équilibres alternatifs qui existent dans un cas de PIG complexe comprenant une ressource et trois utilisateurs (proie, prédateur et prédateur suprême). En d'autres mots, nous avons introduit un prédateur suprême opportuniste (qui veux autant manger le prédateur que la proie) au modèle de @holt_theoretical_1997 basé sur Lotka-Voltera, puis fait varier le type de prédateur pour voir si cela amenait des changement dans les états d'équilibre. 

#En ce qui attrait notre hypothèse, on induit le changement de réponse fonctionnelle, on peut juste émettre des hypothèses sur l’état d’équilibre
#On peut estimer que le super prédateur va supplanter le prédateur pour ultimement maintenir un système à 2 consommateurs
#Ou en fait l’hypothèse mets ce que tu penses, mais on peut juste supposer à quoi la figure aura l’air / le trend de la figure

Nous croyons que l'ajoût d'un prédateur suprême dans l'écosystème permettra des états alternatifs d'équilibres autant stables que instables. Il y aura certainement six cas d'exclusions : absence de proies, absence de proies et de prédateurs, absence de prédateurs, absence de prédateurs et de prédateurs suprêmes, absence de prédateurs suprêmes ainsi que l'absence de prédateurs suprêmes et de proies. Nous sommes aussi confiants que nous serons capables de trouver un équilibre stable de coexistance entre les quatres partis. Par rapport au résultats de @holt_theoretical_1997, il est fort probable que nous observons une augmentation des taux de réponse fonctionnelle vers la ressource commune et de conversion de la ressource commune en nouveaux individus pour compétitionner avec le prédateur suprême ajouter à l'équation dans un cas de coexistance stable.
