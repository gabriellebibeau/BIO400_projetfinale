...
Voici la procédure pour modéliser l'équation différentielle de Lotka-Volterra avec prédation intraguilde complexe (Figure 1). Les variables $b''$ et $a''$ prennent le rôle de variables dépendante et indépendante respectivement. Elle varient de 0 à 1. Les autres variables sont fixées aux valeurs suivantes: $a = 1$, $a' = 0.8$, $\alpha = 1$, $b = 1$, $b' = 0.7$, $\beta = 1$, $K = 1$, $m = 0.5$, $m' = 0.5$, $m'' = 0.2$, $r = 1$, $\gamma = 0.4$, $\delta = 0.4$, $\phi = 0.8$ et finalement $\psi = 0.8$.
...
Pour le premier modèle (basé sur Lotka-Voltera),les figure d'équilibres obtenue selon le choix des paramètres sont les suivantes : 
