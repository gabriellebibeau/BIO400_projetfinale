...
### Résultats
Pour le premier modèle (basé sur Lotka-Voltera), nous avons obtenu les figures d'équilibres suivantes : 


Pour le deuxième modèle (basé sur Schoener), nous avons obtenu les figures d'équilibres suivantes : 
