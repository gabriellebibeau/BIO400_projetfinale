...
![Figure 1 A. Différents états d'équilibres possibles du modèle proie-prédateur de Lotka-Voltera avec prédation intraguilde. Les paramètres  ](Fig1A.png)
...
![Figure 1 B. Différents états d'équilibres possibles lorsqu'il y a de la prédation intraguilde dans le modèle proie-prédateur de Lotka-Volterra avec les conditions ](Fig1B.png)


Dans la figure 1A, les variables $a'$ et $b'$ reprennent le rôle de variables dépendante et indépendante respectivement, alors que les autres variables sont fixés aux mêmes valeurs qu'à la figure 1A, à deux exceptions  : 

$\alpha$ = 1. Ceci représente un cas où la mortalité densité-spécifique de la proie a diminué.

$m$ = 0.1. Ceci représente un cas où la réponse fonctionnelle du prédateur à la proie a augmenté.
