...
#Boucle d'équilibre
grain <- 40 #Résolution de l'image. Un compromis a été fait en la précision et la vitesse d'éxécution du code: un grain plus élevé aurait été souhaitable, mais nous ne croyons pas que cela ai changé drastiquement les résultats (voir Discussion, Figure X)
